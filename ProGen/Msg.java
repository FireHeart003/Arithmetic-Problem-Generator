...
public class Msg {
	...
	public Msg() {
		 ...
		 */
		_w = new Window();
		_i = new ImageIcon((getClass().getResource("tea.jpg")));
		home = new ImageIcon((getClass().getResource("home.png")));
		_t = new ImageIcon((getClass().getResource("angry.png")));
		dog = new ImageIcon((getClass().getResource("dog.png")));
		bye = new ImageIcon((getClass().getResource("bye.png")));
		nice = new ImageIcon((getClass().getResource("nice.png")));
		end = new ImageIcon((getClass().getResource("end.png")));
		idk = new ImageIcon((getClass().getResource("idkboy.png")));
		perf = new ImageIcon((getClass().getResource("perf.png")));

		start();//Starting screen
		
		//Opening message
		_w.msg("You have entered the virtual world of the Arithmetic Problem Generator!"
				+ "\n Rico thought your Math was not good enough after failing a Math FRQ."
